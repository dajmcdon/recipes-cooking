...
This was a favourite cocktail among my graduate school friends. We first tried it at a now-closed bar called Embury near the Strip District in Pittsburgh. 

![](fausts-pact.jpeg)

The bartender moved to [Meat & Potatoes](https://meatandpotatoespgh.com), and we kept ordering it (off 
...
the alcohol to prevent the basil from turning brown. The result is 
neon green, and looks awesome. Leave out the bitters if you do this. 
Otherwise the neon green will become dirt brown.
...
- 3-4 dashes Angostura bitters (omit if blender muddling)
...
1. Combine blender contents with simple syrup, bitters,
